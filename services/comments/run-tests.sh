...
# Script para executar testes do serviço de comentários

echo "🔍 Executando testes do serviço de COMENTÁRIOS..."
echo "=========================================="
...
if [ $? -eq 0 ]; then
    echo "✅ Todos os testes do serviço de COMENTÁRIOS passaram!"
    echo "📊 Relatório de cobertura gerado em htmlcov/"
else
    echo "❌ Alguns testes falharam no serviço de COMENTÁRIOS"
    exit 1
fi
